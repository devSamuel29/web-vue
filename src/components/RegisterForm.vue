<template>
  <main class="m-auto w-[800px]">
    <form class="py-[20px] m-auto flex flex-col w-[50%]">
      <img class="my-[20px]" src="../../public/svg/spotify.svg" alt="spotify-logo" />
      ...
      <div class="flex flex-col w-[80%] m-auto my-[30px]">
        <button type="button" class="flex items-center justify-center border-none text-white py-[8px] rounded-[20px] bg-[#3b5998] hover:brightness-95 hover:scale-[1.04]">
          <img class="mr-2" src="../../public/svg/facebook-logo.svg" alt="facebook-logo" />
          <span class="text-[15px] font-bold">Inscrever-se com o Facebook</span>
        </button>

        <button type="button" class="mt-[15px] flex items-center bg-white justify-center py-[8px] rounded-[20px] border-2 border-solid border-black hover:scale-[1.04]">
          <img class="mr-2" src="../../public/svg/google-logo.svg" alt="google-logo" />
      ...
      <div class="mb-[15px] flex flex-col">
        ...
        <input type="text" class="w-[100%] p-[8px] text-[14px] rounded-[3px] border-2 border-solid border-[#cccccc] focus:outline-none focus:border-black" id="email-input" />
      ...
      <div class="mb-[15px]">
        ...
        <input type="password" class="w-[100%] p-[8px] text-[14px] rounded-[3px] border-2 border-solid border-[#cccccc] focus:outline-none focus:border-black" />
      </div>

      <div class="mb-[15px]">
        <label class="font-bold" for="email-input">Como devemos chamar você?</label>
        <input type="text" class="w-[100%] p-[8px] text-[14px] rounded-[3px] border-2 border-solid border-[#cccccc] focus:outline-none focus:border-black" />
      ...
      <div class="mb-[15px] font-bold">
        ...
        <div class="flex justify-center mt-[5px]" name="date-container">
          <div class="flex flex-col mr-[20px]">
            ...
            <input type="text" class="w-[100px] font-normal p-[8px] outline-none border-2 border-solid border-[#cccccc] rounded-[3px] focus:border-black" name="day-input" placeholder="DD" maxlength="2" />
          </div>
...
" name="months">
          ...
          <div class="flex flex-col">
            ...
            <input type="text" class="w-[100%] p-[8px] font-normal outline-none border-2 border-solid border-[#cccccc] rounded-[3px]" placeholder="AAAA" name="year-input" maxlength="4" />
          </div>
        </div>
      </div>
      ...
      <button type="button" class="border-none rounded-[25px] py-[15px] px-[40px] bg-[#1db954] text-[15px] font-bold w-[50%] m-auto my-[20px] hover:scale-[1.04]">
        Inscrever-se
      </button>

      <h6 class="text-center">
        Já tem uma conta?
        <a class="text-[#1db954]" href="#!">Faça login</a>.
      </h6>
    </form>
  </main>
</template>